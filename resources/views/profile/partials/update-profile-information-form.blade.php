<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="firstname" :value="__('Firstname')" class="text-yellow-950"/>
        ...
        <div>
            <x-input-label for="lastname" :value="__('Lastname')" class="text-yellow-950"/>
        ...
        <div>
            <x-input-label for="email" :value="__('Email')" class="text-yellow-950"/>
